            ...
            {user ? (
              ...
              <div className="py-4">
                ...
                <Form action="/auth/login" method="post">
                  <button
                    type="submit"
                    className="w-full px-4 py-3 text-center font-bold text-primary-600 dark:text-neutral-300 hover:bg-primary-600 dark:hover:bg-primary-600 hover:text-neutral-50 border border-primary-600 dark:border-primary-400 rounded-md transition-colors duration-200"
                  >
                    Sign in
                  </button>
                </Form>
